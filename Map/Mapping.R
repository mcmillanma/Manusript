...
appalachia <- st_read("app_coal_regions.shp")
...
tm_shape(counties)+
  ...
  tm_shape(bugs2, projection = "longlat") + 
    tm_symbols(size = 1, col = "Stream", palette = c("#F8766D", "#F8766D", "#00BA38", "#00BA38","#619CFF", "#619CFF"),
                                                    shape= "Stream", shapes = c( 2, 17, 0, 15, 1, 16), border.lwd = 3, 
  ...
  tm_add_legend('symbol', 
                col = c("#619CFF", "#619CFF", "#00BA38", "#00BA38","#F8766D", "#F8766D"),
                border.col = "grey40",
                labels = c("R1","R2","L1", "L2","H1","H2"),
                shape = c(1, 16, 0, 15, 2, 17),
                title="Stream")
